...
@Getter @Setter
public class ContaBancariaDetalheDTO implements Serializable {
    ...
    public static ContaBancariaDetalheDTO toDTO(ContaBancaria contaBancaria) {
        ContaBancariaDetalheDTO dto = new ContaBancariaDetalheDTO();
